...
In addition to using the Surge Team sst-filters api, we rely on a collection of other Surge team libraries, on the clap/clap-wrapper technology, on the JUCE UI framework, and on supporting libraries simde and fmt. For a full list of projects with their licenses, consult the source base.
